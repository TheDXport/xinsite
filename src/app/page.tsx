    ...
    <div ref={heroRef} className="hero absolute -z-10 w-full invisible-scrollbar">
      <div className="w-full h-full flex flex-col text-white ">
        ...
        <div className="flex flex-col sm:flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 lg:w-1/2 p-4 mt-24 md:mt-36 lg:mt-42 pl-0 sm:pl-6 md:pl-9 lg:pl-32 xl:pl-52 overflow-hidden md:top-0 md:fixed lg:top-0 lg:fixed">
            {/* ORANGE */}
